---
name: brainstorming
description: Use before any creative work - creating features, building components, adding functionality, or modifying behavior - to explore user intent, requirements, and design before implementation.
uses:
  - name: writing-plans
...
- Write the validated design (spec) to `docs/designs/YYYY-MM-DD-<topic>-design.md`
  - (If the repo's AGENTS.md or the user declares a location, use it instead)
...
Show mockups, diagrams, and option comparisons in a browser when seeing beats reading. Setup and usage: `references/visual-companion.md`.
