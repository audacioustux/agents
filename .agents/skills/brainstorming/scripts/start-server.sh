...
# Per-start instance id. stop-server.sh confirms the PID in $PID_FILE is the
# server we started (cmdline carries the id), not an unrelated process whose
# PID got recycled after a restart.
SERVER_ID=""
