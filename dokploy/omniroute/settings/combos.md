...
- `deepseek-v4-flash` folds: `DeepSeek-V4-Flash`, `deepseek-v4-flash`
- `deepseek-v4-pro` folds: `DeepSeek-V4-Pro`, `deepseek-v4-pro`
- `minimax-m2.5` folds: `MiniMax-M2.5`, `minimax-m2.5`
...
- `claude-opus-4-7` → `cc`, `vertex`
- `claude-opus-4-8` → `cc`
- `claude-opus-4.7` → `bzl`, `gh`
- `claude-sonnet-4-6` → `agy`, `cc`, `vertex`
- `claude-sonnet-4.6` → `bzl`, `gh`
...
- `gemini-3.1-flash-lite` → `agy`, `vertex`
- `gemini-3.1-pro-high` → `agy`
- `gemini-3.1-pro-preview` → `bzl`, `gh`, `vertex`
- `gemini-3.5-flash` → `gh`
- `gemini-3.5-flash-high` → `agy`
- `gemma-4-31b-it` → `bzl`, `vertex`
- `glm-5` → `bzl`, `zai`
- `glm-5.1` → `bzl`, `ollamacloud`, `zai`
- `glm-5.2` → `zai`
- `gpt-5.3-codex` → `cx`, `fmd`, `gh`
- `gpt-5.3-codex-spark` → `cx`
- `gpt-5.4` → `bzl`, `cx`, `fmd`, `gh`
- `gpt-5.4-mini` → `bzl`, `cx`, `fmd`, `gh`
- `gpt-5.5` → `bzl`, `cx`, `fmd`, `gh`
- `gpt-5.5-high` → `cx`
- `gpt-5.5-xhigh` → `cx`
...
- `openai/gpt-oss-120b` → `groq`, `nvidia`
- `openai/gpt-oss-20b` → `groq`, `nvidia`
